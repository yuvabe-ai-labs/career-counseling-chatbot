    ...
    <div className="flex gap-2">
      {digits.map((digit, index) => (
        <input
          ...
          className={cn(
            "min-w-0 border border-input bg-background text-center font-display font-semibold text-foreground outline-none transition-colors focus:border-brand focus:ring-2 focus:ring-ring/30 disabled:opacity-40",
